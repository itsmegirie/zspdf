object FrmMain: TFrmMain
  ...
  object scGPPageControl1: TscGPPageControl
    ...
    TabCloseButtonOptions.ShapeKind = scgptcbRect
    ...
    object scGPPageControlPage1: TscGPPageControlPage
      ...
      object scGPPanel1: TscGPPanel
        ...
        object btn_choose_pdf: TscGPButton
          Left = 263
          Top = 36
          Width = 57
          Height = 23
        ...
        object cb_selected_page: TscGPComboBox
          Left = 19
          Top = 148
          Width = 158
          Height = 23
        ...
        object cb_convert_to: TscGPComboBox
          Left = 19
          Top = 204
          Width = 94
          Height = 23
        ...
        object btn_choose_output: TscGPButton
          Left = 263
          Top = 260
          Width = 57
          Height = 23
          ...
          TabOrder = 7
          TabStop = True
          OnClick = btn_choose_outputClick
          Animation = False
          Badge.Color = clRed
          Badge.ColorAlpha = 255
          Badge.Font.Charset = DEFAULT_CHARSET
        ...
        object ed_hidden_filename: TscGPEdit
          Left = 248
          Top = 65
          Width = 72
          Height = 23
      ...
      object scGPPanel2: TscGPPanel
        ...
        WordWrap = False
        ExplicitWidth = 337
        object btn_convert: TscGPButton
          Left = 0
          Top = 0
          Width = 341
          Height = 41
          ...
          Options.HotColor = clGradientActiveCaption
          Options.PressedColor = clGradientActiveCaption
          Options.FocusedColor = clHighlight
          Options.DisabledColor = clBtnFace
          Options.NormalColor2 = clHighlight
          Options.HotColor2 = clGradientActiveCaption
          Options.PressedColor2 = clGradientActiveCaption
          Options.FocusedColor2 = clHighlight
          Options.DisabledColor2 = clNone
          Options.NormalColorAlpha = 255
          Options.HotColorAlpha = 255
          Options.PressedColorAlpha = 255
          ...
          Options.FrameHotColor = clHighlight
          Options.FramePressedColor = clHighlight
          Options.FrameFocusedColor = clGradientActiveCaption
          Options.FrameDisabledColor = clBtnShadow
          Options.FrameWidth = 1
          Options.FrameNormalColorAlpha = 255
          Options.FrameHotColorAlpha = 255
          ...
          Options.FrameFocusedColorAlpha = 255
          Options.FrameDisabledColorAlpha = 255
          Options.FontNormalColor = clBtnHighlight
          Options.FontHotColor = clBtnText
          Options.FontPressedColor = clBtnText
          Options.FontFocusedColor = clBtnHighlight
          Options.FontDisabledColor = clBtnShadow
          Options.ShapeFillGradientAngle = 90
          Options.ShapeFillGradientPressedAngle = -90
          Options.ShapeFillGradientColorOffset = 25
  ...
  object scStatusBar1: TscStatusBar
    ...
    Panels = <
      ...
      item
        Alignment = taCenter
        Text = 'Convert Version 1.0.0'
        Width = 50
      end>
    UseSystemFont = False
    ExplicitWidth = 341
    object ProgressBar1: TscGPProgressBar
      Left = 0
      Top = 0
      Width = 100
      Height = 19
  ...
  object FileOpenDialog1: TFileOpenDialog
    FavoriteLinks = <>
    FileName = 'D:\delphi proj\pdf converter'
    FileTypes = <
      item
        DisplayName = '*.pdf'
        FileMask = '*.pdf'
  ...
  object gtPDFDocument1: TgtPDFDocument
    About = 'Gnostice PDFtoolkit (Circassian Son)'#0#0
    Version = '5.0.0.833'
    OpenAfterSave = False
    MergeOptions = []
